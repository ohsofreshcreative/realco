    ...
    <div class="flex flex-col gap-4"> 
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="{{ $typ['image']['url'] }}" data-fslightbox="gallery-{{ $unique_id }}" data-caption="{{ $typ['title'] }}" class="relative group">
                ...
                {{-- Ikona lupy --}}
                <img src="https://realco.ohsofresh.top/wp-content/uploads/2026/04/zoom-in.svg" alt="Powiększ" class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-6 h-6 pointer-events-none transition-opacity duration-300 opacity-75 group-hover:opacity-0">
            </a>
            @endif
